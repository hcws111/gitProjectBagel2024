var html='<section style="background-color: #eee7e3;">'+
            ...
            '<section>'+
                '<nav class="navbar navbar-expand-lg bg-body-tertiary bg-dark navbar-dark" style="height: 100px;">'+
                    '<div class="container">'+
                        '<a class="navbar-brand offset-2" href="../../f_index.html"><img src="../../images/front/bagel.png" width="60" alt="" class="iconNavBar"></a>'+
                    '<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>'+
                    '<div class="collapse navbar-collapse" id="navbarSupportedContent">'+     
                        '<ul class="navbar-nav me-auto mb-2 mb-lg-0">'+
                            '<li class="nav-item"><a class="nav-link" aria-current="page" href="../../f_index.html">首頁</a></li>'+
